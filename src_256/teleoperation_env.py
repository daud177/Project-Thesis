...
def main(config):
    ...
    save_path = "/home/faps/CEILing/CEILing256/data/" + config["task"] + "/"
    ...
    try: 
        ...
        if not os.path.exists('/home/faps/CEILing/CEILing256/data/'+ config["task"] + '/process_information_teleoperation.csv'): # create a directory to sort the results of process
