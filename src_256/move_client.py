...
# import sys
# sys.path.append('/home/faps/CEILing256/src/iiwa_py3')
...
class move_client:
    def __init__(self):
        ...
        #if not os.path.exists('/home/faps/CEILing256/move_client.csv'): # create a directory to sort the result per day
