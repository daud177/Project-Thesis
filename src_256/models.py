...
class Policy(nn.Module):
    def __init__(self, config):
        ...
        self.conv1 = nn.Conv2d(
            in_channels=3, out_channels=2, kernel_size=5, padding=2, stride=2
        )
        self.conv2 = nn.Conv2d(
            in_channels=2, out_channels=1, kernel_size=5, padding=2, stride=2
        )
        self.conv3 = nn.Conv2d(
            in_channels=1, out_channels=1, kernel_size=5, padding=2, stride=2
        )
