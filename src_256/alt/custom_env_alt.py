...
from rlbench.action_modes.action_mode import MoveArmThenGripper #neu RLBench1.2 GM AE 152
from rlbench.action_modes.gripper_action_modes import Discrete #neu RLBench1.2 GM AE 152
from rlbench.action_modes.arm_action_modes import EndEffectorPoseViaIK #neu RLBench1.2 GM AE 152
from rlbench.backend.exceptions import InvalidActionError #neu RLBench1.2
from rlbench.observation_config import ObservationConfig, CameraConfig
from utils import task_switch, euler_to_quaternion


#from rlbench.task_environment import InvalidActionError #RLBench1.1
#from rlbench.action_modes import ArmActionMode, ActionMode #RLBench1.1
...
class CustomEnv:
    def __init__(self, config):
        ...
        obs_config = ObservationConfig(
            ...
            #front_camera=CameraConfig(rgb=False, depth=False, mask=False), #GM AE162
        ...
        #action_mode = ActionMode(ArmActionMode.EE_POSE_EE_FRAME) #RLBench1.1 GM AE 152
        action_mode = MoveArmThenGripper(
            arm_action_mode=EndEffectorPoseViaIK(False, 'end effector'),
