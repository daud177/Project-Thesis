...
import socket
import time
import logging #if not installed, please run: "pip3 install logging"

# The configuration of the logging settings:
logging.getLogger().setLevel(logging.DEBUG)
logging.basicConfig(level=logging.DEBUG, format='[%(levelname)s] %(asctime)s %(message)s', filename='log0.txt', filemode='w')
...
class mySock:
    ...
    def receive(self):
        ...
        logging.debug(f'Received message: {confirmationMessage}')
